...
The chart show my demo 3 steps
...
3 Step, update blue-ingress resource to redirect redirect  www.springbootdemo.com => springbootdemo-v2 service. and delete green-ingress resource.
